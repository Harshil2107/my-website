    ...
    <>
      <Row className="mt-5 mb-5 hello">
        <Col className="d-flex justify-content-center flex-column ms-5">
          ...
          <Row>
            <p className="description">{process.env.CONFIG.intro}</p>
          </Row>
          <Row className="mt-3" xs="auto">
            <Col className="d-flex">
              <Button
                variant="outline-secondary"
                href={process.env.CONFIG.resume}
                target="_blank"
              >
                <svg
            ...
            <Col className="d-flex">
              <Button
                variant="outline-secondary"
                href={process.env.CONFIG.footerLinks["GitHub"]}
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Col className="d-flex">
              <Button
                variant="outline-secondary"
                href={process.env.CONFIG.footerLinks["LinkedIn"]}
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
